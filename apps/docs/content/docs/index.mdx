...
<Cards>
  ...
  <Card title="Integrity policy" href="/integrity">
    The short version of what providers agree to.
  </Card>
  <Card title="Provider Agreement" href="/provider-agreement">
    The full terms for listing a model on the arena.
  </Card>
